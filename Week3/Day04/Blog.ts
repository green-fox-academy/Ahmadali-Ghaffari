...
class Blog {
    ...
    public addBlogPost(authorName: string, title: string, text: string, publicationDate: string) {



        this._blogPosts.push(new BlogPost(authorName,title,text,publicationDate))  
...
let myBlogPosts = new Blog;

console.log(myBlogPosts);
console.log("''''''''''''''''''''''''''''''''''''''''''''''''''")

console.log("====================After Adding the Blog =========================")

myBlogPosts.addBlogPost("Ahmadali", "The knight is Back", "as a Legendary Hero ,Ahmadali is proving himself !!", "10/07/2019-9:12 pm")
